...
def fidelity_datacollector(network, protocol):
    ...
    def fidelity_calculate(evexpr):
        ...
        #print(qubit_source, qubit_destination, fidelity)
...
run_stats = network_simulation(num_nodes = 16, node_distance = 20, num_iters = 1, depolar_rate = 200, dephase_rate = 200)
print(run_stats)
print("sim done")
#plot_distance(num_iters = 3000, depolar_rate = 150, dephase_rate = 150)
#plot_depolar(num_iters = 500, num_node = 4, input_distance = 10, dephase_rate = 150)
#plot_dephase(num_iters = 600, num_node = 4, input_distance = 10, depolar_rate = 0)
